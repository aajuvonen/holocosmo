# HC-007-MOD: Gravity Laplacian impurity
...
- Output location:         --output-dir                 (default: ../../data/interim/)
- Show plot:               --plot                       (optional flag)

Paper References:
------------------
This simulation builds on HC-006-MOD and on the emergent gravity framework proposed in:
...
def main():
    ...
    filename = f"HC-007-MOD_{timestamp}_gravity_laplacian_impurity_L{Lx}_D{args.bond_dim}_tau{args.tau}_himp{args.h_impurity}.csv"
