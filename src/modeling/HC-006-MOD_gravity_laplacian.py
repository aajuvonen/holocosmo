...
- Output folder:       --output-dir path           (default: ../../data/interim/)
...
def main():
    ...
    parser.add_argument("--output-dir", type=str, default="../../data/interim", help="Directory to store CSV output")
    ...
    filename = f"HC-006-MOD_{timestamp}_gravity_laplacian_L{Lx}_D{D}_tau{tau}.csv"
