# HC-012-TST: Visualize Laplacian 3D
...
def test_visualize_laplacian_3d_runs_minimal():
    ...
    script = root / "src/analysis/HC-012-ANA_visualize_laplacian_3d.py"
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        pngs = list(output_dir.glob("*.svg"))
        assert pngs, "No SVG figure output was generated."
