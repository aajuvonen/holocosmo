# HC-001-TST: Dynamic holographic dark energy
...
def test_holographic_model_runs():
    ...
    script = root / "src/modeling/HC-001-MOD_dynamic_holographic_dark_energy.py"
    ...
    for prefix in expected_prefixes:
        found = list(figures_dir.glob(f"*{prefix}.svg"))
